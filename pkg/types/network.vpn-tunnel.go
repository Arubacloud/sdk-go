...
// VPN encryption algorithms — used by IKESettings.Encryption and ESPSettings.Encryption (54 values)
const (
	VPNEncryptionAES128            = "aes128"
	VPNEncryptionAES192            = "aes192"
	VPNEncryptionAES256            = "aes256"
...
// VPN hash algorithms — used by IKESettings.Hash and ESPSettings.Hash (13 values)
// Note: aes{128,192,256}gmac string values also appear in VPNEncryption*; separate
// constants exist because the API applies them to distinct fields.
const (
	VPNHashMD5        = "md5"
	VPNHashMD5_128    = "md5_128"
	VPNHashSHA1       = "sha1"
	VPNHashSHA1_160   = "sha1_160"
	VPNHashSHA256     = "sha256"
	VPNHashSHA256_96  = "sha256_96"
	VPNHashSHA384     = "sha384"
	VPNHashSHA512     = "sha512"
	VPNHashAESXCBC    = "aesxcbc"
	VPNHashAESCMAC    = "aescmac"
...
// Diffie-Hellman groups — used by IKESettings.DHGroup (22 values: 1, 2, 5, 14..32)
const (
	VPNDHGroup1  = "1"
	VPNDHGroup2  = "2"
	VPNDHGroup5  = "5"
...
// Dead Peer Detection actions — used by IKESettings.DPDAction (3 values)
const (
	VPNDPDActionTrap    = "trap"
	VPNDPDActionClear   = "clear"
	VPNDPDActionRestart = "restart"
...
// Perfect Forward Secrecy options — used by ESPSettings.PFS (24 values)
const (
	VPNPFSEnable    = "enable"
	VPNPFSDisable   = "disable"
	VPNPFSDHGroup1  = "dh-group1"
