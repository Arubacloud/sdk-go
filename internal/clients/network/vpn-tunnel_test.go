...
func TestListVpnTunnels(t *testing.T) {
	t.Run("successful list", func(t *testing.T) {
		server := testutil.NewMockServer(t, func(w http.ResponseWriter, r *http.Request) {
			...
			fmt.Fprint(w, `{"total":1,"values":[{"metadata":{"name":"vpn-1"}}]}`)
		})
...
func TestGetVpnTunnel(t *testing.T) {
	t.Run("successful get", func(t *testing.T) {
		server := testutil.NewMockServer(t, func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(http.StatusOK)
			fmt.Fprint(w, `{"metadata":{"name":"my-vpn"}}`)
		})
		c := testutil.NewClient(t, server.URL)
		svc := NewVPNTunnelsClientImpl(c)
	...
	t.Run("empty project", func(t *testing.T) {
		c := testutil.NewClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Get(context.Background(), "", "vpn-123", nil)
		if err == nil {
			t.Fatal("expected validation error, got nil")
		}
	})
...
func TestCreateVpnTunnel(t *testing.T) {
	...
	t.Run("empty project", func(t *testing.T) {
		c := testutil.NewClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Create(context.Background(), "", types.VPNTunnelRequest{}, nil)
		if err == nil {
			t.Fatal("expected validation error, got nil")
		}
	})
	...
	t.Run("network error", func(t *testing.T) {
		c := testutil.NewBrokenClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Create(context.Background(), "test-project", types.VPNTunnelRequest{}, nil)
		if err == nil {
			t.Fatal("expected transport error, got nil")
		}
	})
...
func TestUpdateVpnTunnel(t *testing.T) {
	t.Run("successful update", func(t *testing.T) {
		server := testutil.NewMockServer(t, func(w http.ResponseWriter, r *http.Request) {
			...
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(http.StatusOK)
			fmt.Fprint(w, `{"metadata":{"name":"updated-vpn"}}`)
		})
		c := testutil.NewClient(t, server.URL)
		svc := NewVPNTunnelsClientImpl(c)
		resp, err := svc.Update(context.Background(), "test-project", "vpn-123", types.VPNTunnelRequest{}, nil)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		if resp.StatusCode != http.StatusOK {
	...
	t.Run("empty project", func(t *testing.T) {
		c := testutil.NewClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Update(context.Background(), "", "vpn-123", types.VPNTunnelRequest{}, nil)
		if err == nil {
			t.Fatal("expected validation error, got nil")
		}
	})
	...
	t.Run("empty vpnTunnelID", func(t *testing.T) {
		c := testutil.NewClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Update(context.Background(), "test-project", "", types.VPNTunnelRequest{}, nil)
		if err == nil {
			t.Fatal("expected validation error, got nil")
		}
	})
	...
	t.Run("network error", func(t *testing.T) {
		c := testutil.NewBrokenClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Update(context.Background(), "test-project", "vpn-123", types.VPNTunnelRequest{}, nil)
		if err == nil {
			t.Fatal("expected transport error, got nil")
		}
	})
...
func TestDeleteVpnTunnel(t *testing.T) {
	...
	t.Run("empty project", func(t *testing.T) {
		c := testutil.NewClient(t, "http://unused.invalid")
		svc := NewVPNTunnelsClientImpl(c)
		_, err := svc.Delete(context.Background(), "", "vpn-123", nil)
		if err == nil {
			t.Fatal("expected validation error, got nil")
		}
	})
	...
	t.Run("not found", func(t *testing.T) {
		...
		c := testutil.NewClient(t, server.URL)
		svc := NewVPNTunnelsClientImpl(c)
		resp, err := svc.Delete(context.Background(), "test-project", "vpn-123", nil)
		if err != nil {
			t.Fatalf("unexpected error: %v", err)
		}
		if resp.StatusCode != http.StatusNotFound {
